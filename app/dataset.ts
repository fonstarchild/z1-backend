...
export let users: { id: number, authToken: string, role: string, name: string }[] = [
    { id: 1, authToken: "teacher", role: ROLES.TEACHER, name: "Godofrasio" },
    { id: 2, authToken: "student", role: ROLES.STUDENT, name: "Teovigildo" }
]

export let levels: { id: number; title: string, description: string }[] = [
...
export let lessons: { id: number; title: string, description: string, level: number }[] = [
