...
const Schema = gql`
    ...
    type Mutation {
        ...
        updateContent(targetContent: ID, title: String, hierarchy: Int, content: String, image: String): TextContent
        updateQuestion(targetQuestion: ID, question: String, type: String,  hierarchy: Int): QuestionContent
